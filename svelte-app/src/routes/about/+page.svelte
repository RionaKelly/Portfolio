...
<div class="carousel">{#if Carousel}
 ...
 >
     <div><center>
      <img src="{base}/riona_red.png" alt="Riona Kelly" width=700>
      </center></div>
     <div><center>
      <img src="{base}/riona_purple.png" alt="Riona Kelly" width=700>
      </center></div>
     <div><center>
      <img src="{base}/riona_bus.png" alt="Riona Kelly" width=700>
      </center></div>
 </Carousel>
{:else}
